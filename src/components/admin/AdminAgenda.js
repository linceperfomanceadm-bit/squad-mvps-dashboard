  ...
  return (
    <div className="fade-up">
      ...
      <div style={{ background: 'rgba(56,189,248,.06)', border: '1px solid rgba(56,189,248,.2)', borderRadius: 12, padding: 16, marginBottom: 18 }}>
        <p style={{ fontSize: 12, fontWeight: 700, color: 'var(--blue)', fontFamily: 'var(--fm)', letterSpacing: '.06em', marginBottom: 10 }}>COMO OBTER A URL</p>
        <ol style={{ margin: 0, paddingLeft: 18, fontSize: 13, color: 'var(--text)', lineHeight: 1.7 }}>
          ...
          <li>Role até <strong>"Integrar agenda"</strong> e copie o endereço dentro de <span style={{ fontFamily: 'var(--fm)', color: 'var(--blue)' }}>src="..."</span> do código de incorporação.</li>
          <li>Cole abaixo e salve.</li>
        </ol>
        <a href="https://calendar.google.com" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 12, color: 'var(--blue)', textDecoration: 'none', marginTop: 10, fontWeight: 600 }}>
      ...
      {loading ? (
        ...
        <>
          <div style={CARD}>
            ...
            />
            <button onClick={save} style={{ display: 'flex', alignItems: 'center', gap: 8, background: 'var(--grad)', border: 'none', borderRadius: 10, padding: '11px 20px', color: 'var(--on)', fontSize: 13, fontWeight: 700, cursor: 'pointer', marginTop: 14, boxShadow: '0 4px 14px rgba(238,51,99,.3)' }}>
          ...
          {config.agendaEmbedUrl && (
            <div style={{ marginTop: 20 }}>
              ...
              <div style={{ borderRadius: 14, overflow: 'hidden', border: '1px solid var(--border)', background: 'var(--bg3)' }}>
